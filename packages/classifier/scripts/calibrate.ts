...
// API clients are initialized via dotenv - no additional setup needed
...
const SAMPLE_PRODUCTS: ClassificationInput[] = [
  {
    ...
    description:
      'Traditional Scandinavian flatbread made with whole grains and seeds. Perfect for cheese and spreads.',
  ...
  },
  {
    ...
    description:
      'Rich dark chocolate with a hint of sea salt. Single origin cacao from Ecuador.',
  ...
  },
  {
    ...
    description:
      'Raw honey infused with chili peppers. Great on pizza, fried chicken, and cheese boards.',
    productType: 'Honey',
  ...
  },
  {
    ...
    description:
      'Smooth, low-acid cold brew made from specialty beans. Just add water or milk.',
    productType: 'Coffee',
  ...
  },
  {
    ...
    description:
      'Try all 4 of our bestselling granola flavors! Includes Maple Pecan, Chocolate Cherry, Vanilla Almond, and Honey Oat.',
    productType: 'Granola',
  ...
  },
  {
    ...
    description:
      'Ceremonial grade matcha from Uji, Japan. Stone-ground for smooth, vibrant flavor.',
    productType: 'Tea',
  ...
  },
  {
    ...
    description:
      'Sweet mango meets fiery habanero in this Caribbean-inspired hot sauce.',
  ...
  },
  {
    ...
    description:
      'Premium Italian EVOO infused with black truffle. Perfect finishing oil for pasta and risotto.',
  ...
  },
  {
    ...
    description:
      'Spanish Marcona almonds roasted with rosemary and sea salt. A gourmet snacking experience.',
    productType: 'Nuts',
  ...
  },
  {
    ...
    description:
      'The perfect gift for cheese enthusiasts! Includes artisan crackers, fig spread, honey, and gourmet nuts.',
  ...
  },
  {
    ...
    description:
      'Unsweetened dried mango from Thailand. No added sugar, just pure fruit.',
  ...
  },
  {
    ...
    description:
      'Traditional Italian pasta made with durum wheat semolina and bronze die cut for perfect sauce adhesion.',
    productType: 'Pasta',
  ...
  },
  {
    ...
    description:
      'Made with hand-picked Oregon strawberries and just a touch of sugar. Tastes like summer.',
    productType: 'Jam',
  ...
  },
  {
    ...
    description:
      'Single-ingredient cashew butter made from roasted cashews. No salt, no sugar, just cashews.',
  ...
  },
  {
    ...
    description:
      'La Vera smoked paprika (Pimentón de la Vera). Sweet variety with deep, smoky flavor.',
    productType: 'Spices',
...
async function runCalibration(
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    try {
      ...
      console.log(
        `  → Confidence: ${(output.category.confidence * 100).toFixed(1)}%${output.needsReview ? ' (needs review)' : ''}`,
      )
  ...
  const avgConfidence =
    successful.length > 0
      ? successful.reduce(
          (sum, r) => sum + (r.output?.category.confidence ?? 0),
          0,
        ) / successful.length
      : 0
  const avgDuration =
  ...
  return {
    ...
    bundlesDetected: successful.filter((r) => r.output?.signals.isBundle)
      .length,
    results,
  }
}
...
function printSummary(summary: CalibrationSummary) {
  ...
  console.log(
    `Needs Review:    ${summary.needsReview} (${((summary.needsReview / summary.successful) * 100).toFixed(1)}%)`,
  )
...
async function main() {
  ...
  const categoriesText = readFileSync(
    join(TAXONOMY_DATA_DIR, 'categories.txt'),
    'utf-8',
  )
